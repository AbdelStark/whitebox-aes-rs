...
## 2025-12-09 13:05 UTC
- Upgraded README with full overview, usage, security model, references, and roadmap.
- Expanded background doc with threat model and attack landscape; added crate-level disclaimers.
- Added CLI demo command documentation and kept tests/clippy/fmt green.
- Next: consider parallel table generation and CLI integration tests when time allows.
