...
//!
//! This crate executes the table network generated by `wbaes-gen`, applying
//! the configured external encodings and round tables to encrypt 32-byte
//! blocks (two AES-128 blocks in parallel).
